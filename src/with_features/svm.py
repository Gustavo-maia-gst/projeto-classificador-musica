...
class SVMGenreClassifier:
    def __init__(self, kernel='rbf', C=2.5, random_state=42):
        self.model = SVC(
            kernel=kernel,
            C=C,
    ...
    def save_model(self, filepath='./src/with_features/svm.model'):
        if not self.is_trained:
            print("Erro: Modelo não foi treinado!")
            return
    ...
    def load_model(self, filepath='./src/with_features/svm.model'):
